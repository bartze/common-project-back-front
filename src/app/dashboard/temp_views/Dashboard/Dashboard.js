						...
						<Grid>
							...
							>
								<Tile>
									...
									>
										<CloseFilled size={32} fill="red" />
									</h5>
									<p>Errors</p>
									<h3 style={{ fontWeight: 'bold' }}>
										{chartStatus.data[0].value}
									</h3>
								</Tile>
							</Column>
							<Column
						...
						<Grid>
							...
							>
								...
								<ReportsTable
									...
									archiveIncidentHandler={
										archiveIncidentReport
									}
								/>
								{modalIsOpen && (
									<ReportModal
