...
/* MIT license */ /* eslint-disable no-mixed-operators */ var cssKeywords = __webpack_require__(95104); // NOTE: conversions should only return primitive values (i.e. arrays, or
...
for(var _i2 = 0, _Object$keys2 = Object.keys(convert); _i2 < _Object$keys2.length; _i2++){
    ...
    var _convert$model2 = convert[model], channels = _convert$model2.channels, labels = _convert$model2.labels;
...
convert.rgb.ansi16 = function(args) {
    ...
    var _args = _slicedToArray(args, 3), r = _args[0], g = _args[1], b = _args[2];
...
__webpack_require__(75177);
var conversions = __webpack_require__(5972);
/*
